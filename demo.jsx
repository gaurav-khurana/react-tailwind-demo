...
// // component using custom react hook
// function DarkMode() {
//   //initialize to custom hook
...
//         label="Dark Mode"
//         onClick={handleToggleDark} // event handler for custom hook
//       />
//     </FormGroup>
//   );
// }
...
//   // useEffect hook used inside Custom Hook to track changes
//   useEffect(() => {
...
//       <button className="button-dark px-4 py-2 ml-10 w-[10vw] border-red-500 bg-amber-500 hover:bg-amber-700 hover:text-white transition-all duration-300 hover:rounded-md ">
//         Love Tailwind CSS with React
//       </button>
//     </main>
//   );
// }
